        ...
        <div className="min-h-screen !bg-[#F2F0FF] pb-24 !text-[#051A2F]">
            ...
            <header className="px-6 pt-8 pb-4">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        ...
                        <h1 className="font-display text-xl font-semibold text-[#051A2F]">
                            Hey there 👋
                        </h1>
                    </div>
                    <Link to="/log">
                        <Button
                            variant="mood"
                            size="lg"
                            className="gap-2 !rounded-2xl !bg-[#2C5FCB] !text-white !shadow-sm hover:!bg-[#244FA7] active:!bg-[#1F448F]"
                        >
            ...
            <section className="px-6 mb-6">
                <div className="grid grid-cols-2 gap-4">
                    <div
                        className="rounded-2xl p-4 border border-black/5 shadow-sm bg-gradient-to-br from-[#E6E2FF] to-[#F3F1FF]">
                        <div className="flex items-center gap-2 mb-2">
                            <TrendingUp className="w-4 h-4 text-[#2C5FCB]"/>
                            <span className="text-[11px] font-semibold tracking-wide uppercase text-[#6B7280]">
                                Weekly Average
                            </span>
                        </div>
                        <p className="font-display text-3xl font-bold text-[#051A2F]">
                    ...
                    <div
                        className="rounded-2xl p-4 border border-black/5 shadow-sm bg-gradient-to-br from-[#DCE9FF] to-[#EEF4FF]">
                        <div className="flex items-center gap-2 mb-2">
            ...
            {!hasEnoughDataForAnalysis() && (
                <section className="px-6 mb-6">
                    <div
                        className="bg-white/80 rounded-2xl p-4 flex items-center gap-3 border border-black/5 shadow-sm">
                        <div className="w-10 h-10 rounded-full bg-[#2C5FCB] flex items-center justify-center shadow-sm">
                        ...
                        <div className="text-right">
                            <p className="font-display text-2xl font-bold text-[#2C5FCB]">
            ...
            <section className="px-6 mb-6">
                <div className="bg-white rounded-2xl p-5 border border-black/5 shadow-sm">
                    <h2 className="text-xs font-semibold tracking-wide uppercase text-[#6B7280] mb-3">
                        Weekly Mood
                    </h2>
                    <h3 className="font-display font-semibold mb-4 text-[#051A2F]">Mood Trends</h3>
